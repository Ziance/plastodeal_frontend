                ...
                <Grid container>
                    ...
                    <Grid item md={6} xs={12} sx={{ display: "flex", justifyContent: "end", marginTop: "2%" }}>
                        <Button variant="contained" sx={{
                            scale: ".85", backgroundColor: "#A3A1A2", "&:hover": {
                                backgroundColor: "#07453a",
                                cursor: "pointer",
                            },
                        }}>Back</Button>
                        <Button variant="contained" sx={{
                            scale: ".85", backgroundColor: btnColor, fontSize: "16px", "&:hover": {
                                backgroundColor: "#07453a",
                                cursor: "pointer",
                            },
                        }} ><AddIcon />Add {" "} {params.dynamicPath?.replace("_", " ")}</Button>
                    </Grid>
                            ...
                            <Table sx={{ minWidth: 650, fontSize: "10px" }} aria-label="simple table" >
                                <TableHead>
                                    <TableRow>
                                        ...
                                        <>
                                        <TableCell align="left" sx={{ fontSize: fontsize }}>Question</TableCell>
                                        <TableCell align="left" sx={{ fontSize: fontsize }}>Answer</TableCell>
                                        <TableCell align="right" sx={{ fontSize: fontsize }}>Country Status</TableCell>
                                        <TableCell align="right" sx={{ fontSize: fontsize }}>Action</TableCell>
                                        </>
                                        :<>
                                        <TableCell align="left" sx={{ fontSize: fontsize }}>{params.dynamicPath?.replace("-", " ")} {" "} Name</TableCell>
                                        <TableCell align="right" sx={{ fontSize: fontsize }}>{params.dynamicPath?.replace("-", " ")} {" "} Status</TableCell>
                                        <TableCell align="right" sx={{ fontSize: fontsize }}>Action</TableCell>
                                        </>}
                                    ...
                                    {rows.map((row) => (
                                        ...
                                        >
                                            ...
                                            <TableCell align="right" >
                                                <Button variant="contained"  sx={{
                                                marginLeft: "80%",
                                                backgroundColor: activeStatus ? "#21BA45" : "#FF3434", display: "flex", justifyContent: "center", height: "20px", textTransform: "initial", p: 1, maxWidth: "30%", fontSize: "100%", "&:hover": {
