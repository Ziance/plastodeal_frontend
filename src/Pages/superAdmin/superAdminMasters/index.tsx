  ...
  const mastersCard = [
    {
      ...
      bgColor: "#DFF5F1",
      iconColor: "#D3E0F9",
      image: <><LanguageIcon sx={{ color: "#ffff" }} /></>
    },
    {
      id: "2",
      heading: "STATE",
      bgColor: "#ECFAE4",
      iconColor: "#D3E0F9",
      image: <><CorporateFareIcon sx={{ color: "#68CF29" }} /></>
    },
    {
      id: "3",
      heading: "CITY",
      bgColor: "#F7EDED",
      iconColor: "#EC5A73",
      image: <>< LocationCityRoundedIcon sx={{ color: "#EC5A73" }} /></>
    },
    {
      id: "4",
      heading: "FAQ",
      bgColor: "#F7EDED",
      iconColor: "#EC5A73",
      image: <><HelpOutlineRoundedIcon sx={{ color: "#EC5A73" }} /></>
    },
    {
      id: "5",
    ...
    },
    {
      ...
      bgColor: "#D3E0F9",
      iconColor: "#EC5A73",
      image: <><ViewCarouselIcon sx={{ color: "#4D73F1  " }} /></>
    },
  ]
  return (
                  ...
                  <Card sx={{ minWidth: "50%", minHeight: "12vh", p: 1, borderRadius: "15px", backgroundColor: "white", cursor: "pointer", boxShadow: ".4px" }}
                   onClick={()=>navigate(`/superadmin/masters/${item.heading.replace(" ","_").toLocaleLowerCase()}`)}>
                    <CardContent sx={{ display: "flex", padding: "0 !important", height: "12vh", alignItems: "center", justifyContent: "flex-start" }}>
                      ...
                      <Typography variant="body1" fontSize="12px">{item.heading}</Typography>
                    </CardContent>
                  </Card>
                </Grid>
              )}
