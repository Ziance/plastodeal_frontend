...
export default function PostReqForm() {
  ...
  return (
    ...
    <Box  width="160vh" display="flex" justifyContent="center">
      <Box
        sx={{
          boxShadow: 3,
          borderRadius: 2,
      ...
      >
        ...
        <Box component="form" onSubmit={handleSubmit} noValidate sx={{ mt: 1 ,display:"flex",flexDirection:"column",justifyContent:"center",alignItems:"center"}}>
         <Grid container pl={8} pr={8} >
         <TextField
            margin="normal"
            required
            fullWidth
