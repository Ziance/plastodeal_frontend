        ...
        <WrapperComponent isHeader>
            ...
            >
                <Grid container >
                    ...
                    <Grid item md={6} display="flex" flexDirection="column" justifyContent="space-evenly" alignItems="center" pl={{ xs: 0, md: 2 }} pr={{ xs: 0, md: 2 }} pt={4} >
                        ...
                        <Box width="100%" height="35vh" marginTop={10}>
                            <Grid container borderRadius={6} bgcolor="white" justifyContent="center">
